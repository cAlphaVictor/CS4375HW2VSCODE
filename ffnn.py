# Programmed by Ciaran Austin Vaille for CS 4375.003 Homework 2 on 11/15/2024
...
def load_data(train_data, val_data):
    ...
    print("Training data sets: {}".format(len(tra)))
    print("Validation data sets: {}".format(len(val)))
    return tra, val
